...
export const transferCoins = async (req, res) => {
  ...
  try {
    ...
    // Create transaction record in TransferCoins collection
...
export const transferToBusiness = async (req, res) => {
  try {
    ...
    const username = "testpay"; // Replace with actual session or auth user
